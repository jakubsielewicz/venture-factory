...
2026-06-19 - HEURISTIC: The entity/operator COUNT used as the market-size denominator must come from a citable primary source (ABS, AIHW, sector regulator, or parliamentary submission). If the count is derived by applying an analyst percentage split to a broader total (e.g. "40–60% of 8,000–12,000 accredited operators = 3,200–7,200 sub-20-truck operators"), the split must itself have a cited source. An unsourced percentage split produces a range that can swing the SOM by 2–3× and must be labelled RISK, not reported as a point estimate or centre of the range. Flag unsourced denominators as G2 blockers. - evidence: asleep-incumbent (3,200–7,200 sub-segment derived from 40–60% split with no primary source; verification called it a G2 blocker), au-sme-compliance (60% award-coverage figure uncited, flagged in verification) - confidence: high (n=2)
