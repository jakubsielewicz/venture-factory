...
2. Score each dimension 1–5, multiply by weight, sum, ×4 → a 0–100 score:
   ...
   - Defensibility / moat potential (0.10)
   - Regulatory drag — inverse, 5 = none (0.10)
3. Flag disqualifiers (legal block, single-platform dependency, zero willingness-to-pay) → automatic KILL regardless of score.
4. Verdict bands: ≥70 PURSUE · 45–69 PARK · <45 KILL.
5. Write `ventures/<slug>/research/opportunity-score.md`: the scorecard table, the score, a one-paragraph verdict, and the top 3 unknowns for G1.
